...
module.exports = async function (eleventyConfig) {
  ...
  eleventyConfig.addPlugin(fontAwesomePlugin, {
    transform: "i[class]", // Automatically converts <i> tags to SVGs
    shortcode: false, // Disable if you don't want {% icon %} shortcode
    failOnError: false, // Gracefully fallback to client-side if icon missing
    defaultAttributes: {
      // Optional: add default classes like 'icon-svg'
      class: "icon-svg",
      "aria-hidden": "true",
    },
  });
