...
(function () {
  ...
  var laxPresets = {
    ...
    scaleInOut: function scaleInOut() {
      var y =
        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 100;
      var str =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.6;
      return {
    ...
    spin: function spin() {
      var y =
        arguments.length > 0 && arguments[0] !== undefined
          ...
          : 1000;
      var str =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 360;
      return {
        rotate: [
          [0, y],
          [0, str],
    ...
    hueRotate: function hueRotate() {
      var y =
        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 600;
      var str =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 360;
      return {
        "hue-rotate": [
  ...
  var laxInstance = (function () {
    ...
    function flattenStyles(styles) {
      ...
      Object.keys(styles).forEach(function (key) {
        ...
        if (translate3dKeys.includes(key)) {
          ...
          flattenedStyles.transform += ""
            .concat(key, "(")
            .concat(val)
            .concat(unit, ") ");
        } else if (filterKeys.includes(key)) {
          flattenedStyles.filter += ""
            .concat(key, "(")
            .concat(val)
            .concat(unit, ") ");
        } else {
      ...
      flattenedStyles.transform = "translate3d("
        .concat(translate3dValues.translateX, "px, ")
        .concat(translate3dValues.translateY, "px, ")
        .concat(translate3dValues.translateZ, "px) ")
        .concat(flattenedStyles.transform);
    ...
    var LaxElement = function LaxElement(
      selector,
      laxInstance,
      domElement,
      transformsData,
      ...
      _defineProperty(this, "update", function (driverValues, frame) {
        ...
        for (var driverName in transforms) {
          ...
          var _driverValues$driverN = _slicedToArray(
              driverValues[driverName],
              2,
            ),
          ...
          for (var key in styleBindings) {
            var _styleBindings$key = _slicedToArray(styleBindings[key], 3),
              ...
              options =
                _styleBindings$key$ === void 0 ? {} : _styleBindings$key$;

            var modValue = options.modValue,
              _options$frameStep = options.frameStep,
              frameStep =
                _options$frameStep === void 0 ? 1 : _options$frameStep,
      ...
      _defineProperty(this, "calculateTransforms", function () {
        ...
        var _loop = function _loop(driverName) {
          ...
          var _styleBindings$preset = styleBindings.presets,
            presets =
              _styleBindings$preset === void 0 ? [] : _styleBindings$preset;
          ...
          var _loop2 = function _loop2(key) {
            var _styleBindings$key2 = _slicedToArray(styleBindings[key], 3),
              ...
              arr1 =
                _styleBindings$key2$ === void 0
                  ? [-1e9, 1e9]
                  : _styleBindings$key2$,
              _styleBindings$key2$2 = _styleBindings$key2[1],
              arr2 =
                _styleBindings$key2$2 === void 0
                  ? [-1e9, 1e9]
                  : _styleBindings$key2$2,
              _styleBindings$key2$3 = _styleBindings$key2[2],
              options =
                _styleBindings$key2$3 === void 0 ? {} : _styleBindings$key2$3;

            var bounds = _this2.domElement.getBoundingClientRect();

            var parsedArr1 = getArrayValues(arr1, windowWidth).map(
              function (i) {
                return parseValue(i, bounds, _this2.groupIndex);
              },
            );
            var parsedArr2 = getArrayValues(arr2, windowWidth).map(
              function (i) {
                return parseValue(i, bounds, _this2.groupIndex);
              },
            );
    ...
    var Lax = function Lax() {
      ...
      _defineProperty(this, "onWindowResize", function () {
        var changed =
          document.body.clientWidth !== _this3.windowWidth ||
          document.body.clientHeight !== _this3.windowHeight;
      ...
      _defineProperty(this, "onAnimationFrame", function (e) {
        ...
        if (_this3.debug) {
          _this3.debugData.frameLengths.push(
            Date.now() - _this3.debugData.frameStart,
          );
        }

        if (_this3.frame % 60 === 0 && _this3.debug) {
          var averageFrameTime = Math.ceil(
            _this3.debugData.frameLengths.reduce(function (a, b) {
              return a + b;
            }, 0) / 60,
          );
          console.log(
            "Average frame calculation time: ".concat(averageFrameTime, "ms"),
          );
      ...
      _defineProperty(this, "findAndAddElements", function () {
        ...
        elements.forEach(function (domElement) {
          ...
          _this3.elements.push(
            new LaxElement(".lax", _this3, domElement, transforms, 0, {}),
          );
        });
      });
      ...
      _defineProperty(
        this,
        "addElements",
        function (selector, transforms, options) {
      ...
      _defineProperty(
        this,
        "addElement",
        function (domElement, transforms, options) {
          _this3.elements.push(
            new LaxElement("", _this3, domElement, transforms, 0, options),
          );
        },
      );
